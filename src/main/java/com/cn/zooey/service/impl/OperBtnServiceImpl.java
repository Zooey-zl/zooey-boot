 ...
 */
@Service
public class OperBtnServiceImpl extends ServiceImpl<OperBtnMapper, OperBtn> implements OperBtnService {

    @Resource
    private OperBtnMapper operBtnMapper;
    ...
    public ResResult<ResPage<OperBtn>> listOperBtn(OperBtnListVO operBtnListVO) {
        ...
        IPage<OperBtn> operBtnIPage = super.page(iPage, queryWrapper);
    ...
    public ResResult<?> endisableOperBtn(Long id, Byte state) {
        ...
        OperBtn operBtn = super.getById(id);
