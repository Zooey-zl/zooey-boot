...
public class GenerationConsts {
    ...
    protected static final String GLOBAL_COMMENT_DATE = "yyyy-MM-dd";
    ...
    protected static final String PACKAGE_MAPPER_XML = "mapper.xml";
    protected static final String PACKAGE_CONTROLLER = "controller";

    protected static final String DELETE_COLUMN_NAME = "deleted";
    protected static final String DELETE_PROPERTY_NAME = "deleted";
}
